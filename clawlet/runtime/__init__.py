...
_LAZY_IMPORTS = {
    ...
    "EVENT_SCHEDULED_RUN_STARTED": ("clawlet.runtime.events", "EVENT_SCHEDULED_RUN_STARTED"),
    "EVENT_SCHEDULED_RUN_COMPLETED": ("clawlet.runtime.events", "EVENT_SCHEDULED_RUN_COMPLETED"),
    "EVENT_SCHEDULED_RUN_FAILED": ("clawlet.runtime.events", "EVENT_SCHEDULED_RUN_FAILED"),
    "SCHED_PAYLOAD_JOB_ID": ("clawlet.runtime.events", "SCHED_PAYLOAD_JOB_ID"),
    "SCHED_PAYLOAD_RUN_ID": ("clawlet.runtime.events", "SCHED_PAYLOAD_RUN_ID"),
    "SCHED_PAYLOAD_SOURCE": ("clawlet.runtime.events", "SCHED_PAYLOAD_SOURCE"),
    "SCHED_PAYLOAD_SESSION_TARGET": ("clawlet.runtime.events", "SCHED_PAYLOAD_SESSION_TARGET"),
    "SCHED_PAYLOAD_WAKE_MODE": ("clawlet.runtime.events", "SCHED_PAYLOAD_WAKE_MODE"),
