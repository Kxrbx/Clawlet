...
Release `0.4.4` also improves conversation continuity by restoring recent SQLite-backed session history, persisting summary metadata across reloads, and making prompt memory injection more query-aware.
